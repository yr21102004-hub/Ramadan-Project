...
PROJECTS_DATA = {
    ...
    'villas': {
        ...
        'hero_image': 'luxury_bg_villas_new.jpg',
        ...
        'images': ['palace.png', 'villa.png', 'villa_2.png'],
        'sections': [
            {
                'title': 'نطاق الخدمات',
                'details': [
    ...
    'hotels': {
        ...
        'hero_image': 'luxury_bg_hotels_pattern.jpg',
    ...
    'factories': {
        ...
        'hero_image': 'luxury_bg_factories_new.png',
        ...
        'images': ['factory_1.png', 'factory_2.png', 'factory_3.png', 'factory_4.png'],
        'sections': [
            {
