...
SERVICES_DATA = {
    ...
    'integrated-finishing': {
        ...
        'image': 'integrated_finishing.webp'
    },
    'putty-finishing': {
...
PROJECTS_DATA = {
    'apartments': {
        'title': 'بنود دهانات الشقق السكنية الفاخرة',
        'hero_image': 'luxury_bg_apartments_new.webp',
        'description': 'نقدّم أعمال دهانات داخلية فاخرة للشقق السكنية، مصممة بعناية لتوازن بين الجمال العملي والرقي البصري. نعتمد على أفضل أنواع الدهانات العالمية عالية الجودة، مع تطبيق احترافي يضمن أسطحًا ناعمة، ألوانًا متجانسة، وتشتشطيبات تدوم طويلًا مع سهولة الصيانة.<br><br>تشمل خدماتنا تنفيذ تشطيبات متنوعة تناسب مختلف الأذواق والأنماط المعمارية، من التشطيبات المطفية الأنيقة، إلى الحريرية والساتان الراقية، مرورًا بلمسات زخرفية خفيفة عند الطلب. كما نوفّر حلولًا مخصصة لحوائط مميزة تضيف عمقًا وجاذبية للمساحات دون الإخلال بالانسجام العام للتصميم الداخلي.<br><br>نلتزم بمنهجية تنفيذ دقيقة تبدأ بالتحضير المثالي للأسطح عبر معالجة الشروخ والعيوب، وتطبيق المعجون والصنفرة والبرايمر قبل الدهان النهائي، بما يضمن ثبات اللون، مقاومة البقع، ومظهرًا احترافيًا خاليًا من العيوب.<br><br>نراعي أعلى معايير النظافة والسلامة أثناء التنفيذ، مع حماية كاملة للأرضيات والأثاث، وتسليم المشروع بتشطيب نظيف يعكس الفخامة والاهتمام بالتفاصيل. هدفنا خلق بيئة سكنية مريحة، أنيقة، وعصرية ترتقي بقيمة الشقة وجمالها.',
        'images': ['apartment_1.webp', 'apartment_2.webp', 'apartment_3.webp'],
        'sections': [
            {
                'title': 'تجهيز الأسطح',
                'details': [
    ...
    'villas': {
        ...
        'hero_image': 'luxury_bg_villas_new.webp',
        ...
        'images': ['palace.webp', 'villa.webp', 'villa_2.webp'],
        'sections': [
            {
                'title': 'نطاق الخدمات',
                'details': [
    ...
    'companies': {
        ...
        'hero_image': 'luxury_bg_companies_new.webp',
        ...
        'images': ['office_1.webp', 'office_2.webp', 'office_3.webp'],
        'sections': [
            {
                'title': 'تجهيز الأسطح',
                'details': [
            ...
            },
            {
                ...
                'details': [
                    ...
                    'استخدام ألوان رسمية هادئة متوافقة مع الهوية البصرية للمنشأة.',
    ...
    'hotels': {
        ...
        'hero_image': 'luxury_bg_hotels_pattern.webp',
        ...
        'images': ['hotel_1.webp', 'hotel_2.webp', 'hotel_3.webp', 'hotel_4.webp'],
        'sections': [
            {
    ...
    'factories': {
        ...
        'hero_image': 'luxury_bg_factories_new.webp',
        'description': 'نقدم حلول دهانات داخلية متخصصة للمصانع والمنشآت الصناعية وفق أعلى معايير الجودة والمتانة والسلامة التشغيلية. نعتمد على أنظمة دهانات تقنية عالية الأداء مصممة لتحمّل البيئات الصناعية القاسية، بما في ذلك الرطوبة، الحرارة، الاحتكاك، الأبخرة الكيميائية، والغبار، مع الحفاظ على مظهر نظيف واحترافي طويل الأمد.<br><br>تشمل أعمالنا دهانات أرضيات إيبوكسية مضادة للانزلاق، دهانات جدران وأسقف مقاومة للبقع والرطوبة، ودهانات حماية معدنية مضادة للصدأ، باستخدام مواد معتمدة من كبرى الشركات العالمية وبمطابقة لمعايير السلامة الصناعية.<br><br>نلتزم بمنهجية تنفيذ دقيقة تبدأ بإعداد الأسطح بشكل علمي يشمل التنظيف الصناعي، إزالة الأتربة والملوثات، معالجة الشروخ والعيوب، ثم تطبيق برايمر متخصص يضمن التصاقاً قوياً وثباتاً عالياً للطبقات النهائية. يتم تطبيق الدهانات على طبقات مدروسة بسُمك محسوب لضمان أعلى مستوى من المتانة والمقاومة.<br><br>نراعي في جميع مراحل التنفيذ متطلبات التشغيل داخل المنشأة، مع خطط عمل منظمة تقلل التعطيل، والالتزام بإجراءات الصحة والسلامة المهنية، وحماية المعدات والآلات أثناء العمل. كما نحرص على تسليم المشروع بتشطيب نظيف، متجانس، وخالٍ من العيوب البصرية أو الوظيفية.<br><br>هدفنا هو توفير حلول دهانات صناعية لا تقتصر على الشكل الجمالي فقط، بل تعزز الأداء الوظيفي للمكان، وتطيل العمر الافتراضي للأسطح، وتقلل تكاليف الصيانة المستقبلية، بما يضمن أعلى عائد استثماري لعملائنا.',
        'images': ['factory_1.webp', 'factory_2.webp', 'factory_3.webp', 'factory_4.webp'],
        'sections': [
            {
